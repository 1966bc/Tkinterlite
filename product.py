...
class Dialog(tk.Toplevel):     
    def __init__(self,parent,engine):
        ...
        self.txtStock.grid(row=5, column=1)
    ...
    def on_save(self,):
        ...
        if messagebox.askquestion("Save", "Do you want to save?"):
            ...
            self.parent.on_open()
            #self.parent.lstProducts.selection_set(str(self.selected_product[0]))
            self.on_cancel()
    ...
    def set_values(self,):
        ...
        self.txtStock.insert(0, self.selected_product[6])
