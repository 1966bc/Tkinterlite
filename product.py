...
class Dialog(tk.Toplevel):     
    def __init__(self,parent,engine):
        ...
        Label(self, text="Product:",  anchor='w').grid(row=0)
        Label(self, text="Suppliers:",  anchor='w').grid(row=1)
        Label(self, text="Categories:",  anchor='w').grid(row=2)
        Label(self, text="Package:",  anchor='w').grid(row=3)
        Label(self, text="Price:",  anchor='w').grid(row=4)
        Label(self, text="Stock:",  anchor='w').grid(row=5)
        
        self.txtProduct = Entry(self, bg='white')
        self.cbSuppliers =  ttk.Combobox(self,)
        self.cbCategories =  ttk.Combobox(self,)
        self.txtPackage = Entry(self,bg='white')
        self.txtPrice = Entry(self,bg='white')
        self.spStock = Spinbox(self,bg='white',
